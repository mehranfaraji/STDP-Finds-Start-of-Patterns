...
def plot_input(times, indices, params, times_pattern=None, indices_pattern=None,):
...
def plot_potential(start_time, end_time, model, position_copypaste, patternlength, dt):
    plt.figure(figsize=(12,5))
